...
const ThreadListNew: FC = () => {
  return (
    <ThreadListPrimitive.New asChild>
      <Button
        className="flex items-center justify-start gap-2 rounded-lg px-2.5 py-2 text-start text-white font-semibold transition-all hover:opacity-90 active:scale-95"
